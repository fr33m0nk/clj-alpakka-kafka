(ns fr33m0nk.kafka-stream-with-producer-test
...
(defn kafka-stream-with-producer
      ...
      (s/map-async 2
                   (fn [message]
                     (let [_key (consumer/key message)
                           ...
                           message-to-publish (producer/->producer-record producer-topic (processing-fn value))]
